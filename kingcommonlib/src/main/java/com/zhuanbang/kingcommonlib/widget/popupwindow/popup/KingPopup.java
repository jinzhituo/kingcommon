 ...
 */
public class KingPopup extends KingBasePopup {
    ...
    public KingPopup(Context context) {
        this(context, DIRECTION_NONE);
    }


    public KingPopup(Context context, int preferredDirection) {
        super(context);
     ...
     * 设置根据计算得到的位置后的偏移值
     */
    public KingPopup setPositionOffsetX(int offsetX) {
        mOffsetX = offsetX;
        return this;
    }
     ...
     */
    public KingPopup setPositionOffsetYWhenTop(int offsetYWhenTop) {
     ...
     */
    public KingPopup setPositionOffsetYWhenBottom(int offsetYWhenBottom) {
     ...
     * @return
     */
    public KingPopup setPreferredDirection(int preferredDirection) {
        mPreferredDirection = preferredDirection;
        return this;
    }
    ...
    public void setContentView(View root) {
        FrameLayout layout = (FrameLayout) LayoutInflater.from(getContext()).inflate(R.layout.king_widget_popup, null, false);
