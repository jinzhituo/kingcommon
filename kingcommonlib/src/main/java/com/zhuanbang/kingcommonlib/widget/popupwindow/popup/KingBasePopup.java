 ...
 */
public abstract class KingBasePopup {
     ...
     */
    public KingBasePopup(Context context) {
        mContext = context;
     ...
     * @param listener
     */
    public KingBasePopup setOnDismissListener(PopupWindow.OnDismissListener listener) {
    ...
    public class RootView extends FrameLayout {
        ...
        protected void onConfigurationChanged(Configuration newConfig) {
            ...
            KingBasePopup.this.onConfigurationChanged(newConfig);
