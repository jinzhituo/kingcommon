 ...
 *
 */
public class KingWrapContentListView extends ListView {
    private int mMaxHeight = Integer.MAX_VALUE >> 2;

    public KingWrapContentListView(Context context) {
        super(context);
    }

    public KingWrapContentListView(Context context, int maxHeight) {
        super(context);
        mMaxHeight = maxHeight;
    }

    public KingWrapContentListView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initAttrs(context, attrs);
    }

    public KingWrapContentListView(Context context, AttributeSet attrs, int defStyleAttr) {
