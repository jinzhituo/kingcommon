...
//                componentName = ComponentName.unflattenFromString("com.vivo.permissionmanager/.activity" +
//                        ".BgStartUpManagerActivity");
                ...
                componentName = ComponentName.unflattenFromString("com.coloros.safecenter/.startupapp" + "" + "" + ""
     ...
     * @param context
     */
    public static void jumpSafeBack(Context context) {
        Intent intent = new Intent();
        try {
            intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
            ComponentName componentName = null;
...
//                componentName = new ComponentName("com.vivo.abe", "com.vivo.applicationbehaviorengine.ui" + "" + "" +
//                        ".ExcessivePowerManagerActivity");
                //加速白名单
                componentName = new ComponentName("com.iqoo.secure", "com.iqoo.secure.ui.phoneoptimize" + "" +
                        ".AddWhiteListActivity");
            } else if (getMobileType().equals("OPPO")) { // OPPO R8205测试通过
                componentName = new ComponentName("com.coloros.oppoguardelf", "com.coloros.powermanager.fuelgaue" +
                        "" + ".PowerUsageModelActivity");
